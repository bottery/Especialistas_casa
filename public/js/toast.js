...
window.ToastNotification = {
    show(message, type = 'info', duration = 4000) {
        ...
        toast.innerHTML = `
            <div class="flex items-start space-x-3 ${colors[type]} border-l-4 rounded-r-lg p-4 shadow-lg max-w-md">
                ...
                <button onclick="this.closest('.toast-notification').remove()" class="flex-shrink-0 ml-4 text-gray-400 hover:text-gray-600">
