    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center">
                    <div class="flex items-center relative">
                        <div :class="paso >= 1 ? 'bg-teal-600' : 'bg-gray-300'" class="rounded-full h-10 w-10 flex items-center justify-center text-white font-semibold">1</div>
                        <span class="ml-2 text-sm font-medium" :class="paso >= 1 ? 'text-teal-600' : 'text-gray-500'">Servicio</span>
                    </div>
                    <div class="w-24 h-1 mx-4" :class="paso >= 2 ? 'bg-teal-600' : 'bg-gray-300'"></div>
                    <div class="flex items-center">
                        <div :class="paso >= 2 ? 'bg-teal-600' : 'bg-gray-300'" class="rounded-full h-10 w-10 flex items-center justify-center text-white font-semibold">2</div>
                        <span class="ml-2 text-sm font-medium" :class="paso >= 2 ? 'text-teal-600' : 'text-gray-500'">Detalles</span>
                    </div>
                    <div class="w-24 h-1 mx-4" :class="paso >= 3 ? 'bg-teal-600' : 'bg-gray-300'"></div>
                    <div class="flex items-center">
                        <div :class="paso >= 3 ? 'bg-teal-600' : 'bg-gray-300'" class="rounded-full h-10 w-10 flex items-center justify-center text-white font-semibold">3</div>
                ...
                <div x-show="especialidadesDisponibles.length > 0" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <template x-for="esp in especialidadesDisponibles" :key="esp">
                        <div @click="seleccionarEspecialidad(esp)" 
                             class="bg-gradient-to-br from-blue-50 to-teal-50 rounded-xl p-5 cursor-pointer hover:shadow-xl hover:scale-105 transition-all duration-200 border-2 border-transparent hover:border-blue-500 group">
                            <div class="flex flex-col items-center text-center">
        ...
        <div x-show="paso === 2 && !loading">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 space-y-6">
                ...
                <div class="flex justify-between pt-4 border-t">
                    ...
                    <button @click="paso = 3" class="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700">
        ...
        <div x-show="mostrarModalExito" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="background-color: rgba(0,0,0,0.5);">
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all"
                ...
                <!-- Footer -->
                <div class="px-6 pb-6">
                    <button @click="irAMisSolicitudes()" class="w-full py-3 bg-gradient-to-r from-blue-600 to-teal-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-teal-700 transition-all shadow-lg">
