...
<head>
    ...
    <script>
    // Sistema de logging y captura de errores (movido al head para evitar race conditions con Alpine)
    window.errorLog = {
        logs: [],
    ...
    // Definición de la app del dashboard en window para que Alpine la encuentre al inicializar
